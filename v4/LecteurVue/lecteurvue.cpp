    ...
    , ui(new Ui::LecteurVue)
{
    ...
    QPixmap pix("F:/S2/S201/v4/cartesDisney/Disney_tapis.png");
...
void LecteurVue::chargerDiaporama()
{
    ...
    Image* imageACharger;
    imageACharger = new Image(3, "Animal", "Le dalmatien", "F:/S2/S201/v4/cartesDisney/Disney_1.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(2, "Personne", "Alice au Pays des Merveilles", "F:/S2/S201/v4/cartesDisney/Disney_2.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "Animal", "Bambi", "F:/S2/S201/v4/cartesDisney/Disney_3.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "Personne", "Blanche-Neige", "F:/S2/S201/v4/cartesDisney/Disney_4.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(5, "Animal", "Daisy", "F:/S2/S201/v4/cartesDisney/Disney_5.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(6, "Animal", "La Belle et le Clochard", "F:/S2/S201/v4/cartesDisney/Disney_6.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(7, "Personne", "Jasmine", "F:/S2/S201/v4/cartesDisney/Disney_7.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(8, "Animal", "Donald", "F:/S2/S201/v4/cartesDisney/Disney_8.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(9, "Animal", "Donald", "F:/S2/S201/v4/cartesDisney/Disney_9.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(10, "Animal", "Mushu", "F:/S2/S201/v4/cartesDisney/Disney_10.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(11, "Animal", "Dumbo", "F:/S2/S201/v4/cartesDisney/Disney_11.gif");
    _diaporama.push_back(imageACharger);
