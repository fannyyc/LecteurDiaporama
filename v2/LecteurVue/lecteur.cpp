...
void Lecteur::chargerDiaporama()
{
    ...
    imageACharger = new Image(2, "Princesse", "Cendrillon", "F:/S2/S201/v2/cartesDisney/Disney_2.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(4, "Princesse", "Bambi", "F:/S2/S201/v2/cartesDisney/Disney_3.gif");
    _diaporama.push_back(imageACharger);
    imageACharger = new Image(1, "Princesse", "Blanche-Neige", "F:/S2/S201/v2/cartesDisney/Disney_4.gif");
    _diaporama.push_back(imageACharger);
